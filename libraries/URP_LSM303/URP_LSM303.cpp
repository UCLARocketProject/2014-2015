...
*/
/**************************************************************************/
void URP_LSM303_Accel::write8(byte address, byte reg, byte value)
{
...
*/
/**************************************************************************/
byte URP_LSM303_Accel::read8(byte address, byte reg)
{
  byte value;
...
*/
/**************************************************************************/
URP_LSM303_Accel::URP_LSM303_Accel(int32_t sensorID) {
  _sensorID = sensorID;
}
...
*/
/**************************************************************************/
void URP_LSM303_Accel::getSensor(sensor_t *sensor) {
...
*/
/**************************************************************************/
void URP_LSM303_Accel::setDataRate(byte rate) {
	byte reg1_a = read8((byte)LSM303_ADDRESS_ACCEL, (byte)LSM303_REGISTER_ACCEL_CTRL_REG1_A);
	reg1_a = (reg1_a & 0x0F) | (rate << 4); // set top 4 bits to new rate
	write8((byte)LSM303_ADDRESS_ACCEL, (byte)LSM303_REGISTER_ACCEL_CTRL_REG1_A, reg1_a);
}
